...
|---------|-------------|-------------|
| [`/relatorio`](./relatorio/README.md) | Daily delivery report from Trello, formatted for WhatsApp | [Setup](./relatorio/SETUP.md) |
...
2. Copy the commands to the Claude Code global directory:
   ```bash
   cp ~/projects/ai-toolkit/commands/* ~/.claude/commands/
   ```
